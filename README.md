...
**Interstate System:**
- **I-285 ("The Perimeter")**: 64-mile loop encircling Atlanta, 8-12 lanes wide (up to 18 lanes at Spaghetti Junction)
- **I-75**: North-south route through metro Atlanta
- **I-85**: Northeast-southwest route through metro Atlanta  
...
<cite index="4-11,4-12,4-13">MARTA has four service lines: Red, Gold, Blue, and Green. The Red and Gold lines run along the North-Northeast corridor, and the Blue and Green Lines run along the West-East corridor. The two corridors connect at Five Points station, the only station where transfers are possible between all four lines.</cite>

**Current Configuration (38 stations, 48 miles):**
...
```
                    ...
                    Medical Center ●
                      ...
                      Buckhead ●
                          |
                    Lindbergh Center ●――――――● Lenox
                          |                  |
                     Arts Center ●      Brookhaven ●
                          |                  |
                       Midtown ●         Chamblee ●
                          |                  |
                    North Avenue ●       Doraville ●
                          |
                     Civic Center ●
                          |
                  Peachtree Center ●
                          |
Bankhead ●―●―● Five Points ●―●―●―●―●―● Indian Creek
              |           |
    ...
    Oakland City ● Inman Park/Reynoldstown ●
              |           |
Lakewood/Ft Mac ●  Edgewood/Candler Park ●
              |           |
...
**Lines:**
- **Red Line**: North Springs ↔ Airport (19 stations)
- **Gold Line**: Doraville ↔ Airport (18 stations)  
...
## IMPROVED TRANSPORTATION PATTERN

### Proposed Highway Improvements

**1. Outer Perimeter Loop (I-485 or New Bypass)**
```
Purpose: Divert through-traffic and trucks around metro area
Benefits: Reduce I-285 congestion by 30-40%

        NEW OUTER LOOP (~90-100 miles)
...
**2. Express/Managed Lane Network**
<cite index="11-28,11-30,11-31">Add express lanes on I-285 from I-20 across the north end to I-20, with two express lanes in each direction between key interchanges</cite>

**3. Smart Traffic Management**
<cite index="37-1,37-2">Implement intelligent transportation systems with IoT sensors at signalized intersections to improve traffic flow</cite>

### Proposed MARTA Expansion

**Phase 1: Infill Stations (2025-2028)**
<cite index="23-1,23-4">Add four new stations: Armour Yards and Murphy Crossing on North/South lines, and Krog Street/Hulsey Yards and Joseph E. Boulevard on East/West lines</cite>

**Phase 2: Rail Extensions (2028-2035)**

**A. Extended Network Map**
...
```
                Cumming/Forsyth ●  (NEW)
                   ...
                   Armour Yards ●  (NEW INFILL)
                    ...
                    North Avenue ●       Doraville ●
                          |                  |
                     Civic Center ●    Gwinnett Place ●  (NEW)
                          |                  |
                  Peachtree Center ●   Pleasant Hill ●  (NEW)
                          |
 Marietta/Town Center ●―●―● Five Points ●―●―● Stonecrest ●  (NEW)
             (NEW)  |           |                  |
         Smyrna ●―●●  Garnett ●   Georgia State ●―●● Lithonia ●  (NEW)
             (NEW)  |           |
    Cumberland ●―●  West End ●  King Memorial ●
          (NEW)  |      |           |
                  |  Murphy Crossing ●  (NEW INFILL - BELTLINE CONNECTION)
                  |      |           |
 Douglasville ●―●―● Oakland City ● Inman Park ●――――BELTLINE LOOP――――●
       (NEW)       |           |                                      |
        Lakewood/Ft Mac ●  Edgewood ●                                |
                  |           |                                      |
Fairburn ●― East Point ●  East Lake ●                                |
  (NEW)       |           |                                          |
      College Park ●  Decatur ●                                      |
              |           |                                          |
 Union City ● Airport ● Avondale ●                                   |
   (NEW)                  |                                          |
                    Kensington ●                                     |
                          |                                          |
                    Indian Creek ●―――――――――――――――――――――――――――――――●
...
**B. BeltLine Integration**
<cite index="40-11,40-13">Connect Downtown to BeltLine via Streetcar East Extension and utilize dedicated right-of-way on Southside Trail for streetcar/light-rail service</cite>

**New Light Rail Loop on BeltLine (22 miles):**
```
         Westside Trail
              |
         Murphy Crossing
    ...
    ――――Northwest Trail――――
    |                     |
Armour Yards      Northeast Trail
(Red/Gold)               |
    |           Krog Street/Hulsey
    |           (Blue/Green)
    |                     |
Southwest Trail    Eastside Trail
    |                     |
    ――――Southeast Trail――――
              |
         Southside Trail
...
**C. Suburban Extensions**

1. **North Extensions:**
   - Red Line: North Springs → Alpharetta → Cumming (12 miles)
   - Benefits: Serves 200,000+ residents in rapidly growing North Fulton

2. **Northeast Extensions:**
   - Gold Line: Doraville → Gwinnett Place → Pleasant Hill (8 miles)
   - Benefits: Finally connects Gwinnett County (1M+ population)

3. **East Extensions:**
   - Blue Line: Indian Creek → Stonecrest → Lithonia (10 miles)
   - Benefits: Serves eastern DeKalb County employment centers

4. **West Extensions:**
   - Blue Line: Hamilton E. Holmes → Marietta → Town Center (12 miles)
   - Green Line: Bankhead → Cumberland → Smyrna (8 miles)
   - Benefits: Connects to major Cobb County employment centers

5. **South Extensions:**
   - Red/Gold Lines: College Park → Union City → Fairburn (8 miles)
   - Benefits: Connects southern suburbs and Clayton County
...
| Improvement | Cost Estimate | Timeline | Impact |
|------------|--------------|----------|---------|
| Outer Perimeter Loop | $15-20B | 15-20 years | 30-40% reduction in I-285 through-traffic |
| Express Lanes Network | $5-8B | 8-10 years | 20% reduction in peak congestion |
| Smart Traffic Systems | $500M-1B | 3-5 years | 15-20% improvement in traffic flow |
| Interchange Improvements | $3-5B | 10 years | Reduce bottleneck delays by 25% |

**Total Highway Investment:** $23.5-34B over 20 years

### MARTA System Improvements

| Improvement | Miles | Stations | Cost Estimate | Timeline |
|------------|-------|----------|--------------|----------|
| Infill Stations | 0 | 4 | $400-600M | 3-5 years |
| BeltLine Rail Loop | 22 | 15-20 | $3-4B | 8-12 years |
| Suburban Extensions | 58 | 25-30 | $10-15B | 15-20 years |
| Station Modernization | - | 38 existing | $1B | 10 years |
| Bus Rapid Transit | 50 | 75-100 | $2-3B | 10 years |

**Total MARTA Investment:** $16.4-23.6B over 20 years
...
### Phase 1 (Years 1-5): Quick Wins
1. Complete 4 MARTA infill stations
2. Implement smart traffic management systems
3. Begin BeltLine rail construction (Southside Trail priority)
4. Start express lanes on northern I-285

### Phase 2 (Years 6-10): Major Expansions
1. Complete BeltLine rail loop
2. Begin suburban MARTA extensions (Gwinnett, Cobb priorities)
3. Complete I-285 express lanes network
4. Modernize existing MARTA stations

### Phase 3 (Years 11-20): Regional Integration
1. Complete all suburban rail extensions
2. Build outer perimeter loop
3. Implement comprehensive bus rapid transit network
4. Create multimodal transportation hubs

---

## Funding Sources

1. **More MARTA Sales Tax**: $2.7B over 40 years (approved 2016)
2. **Federal Infrastructure Grants**: $8-12B potential
3. **State Transportation Funds**: $5-8B
4. **Regional Transportation Sales Tax**: $10-15B (needs voter approval)
5. **Public-Private Partnerships**: $5-10B
6. **Congestion Pricing/Tolls**: $3-5B over 20 years

**Total Available Funding (Potential):** $33.7-52.7B

---

## Equity and Community Protection Framework

### Historical Context

Atlanta's highway system has a legacy of harm to Black communities:
- **I-20 and I-75/85** were built through thriving Black neighborhoods in the 1950s-60s
- Destroyed communities like Sweet Auburn, Buttermilk Bottom, and Summerhill
- Physically separated neighborhoods and displaced thousands of residents
- Created barriers that persist today

### Core Principles for Equitable Improvements

**1. NO NEW HIGHWAYS through existing residential neighborhoods**
- Outer perimeter MUST use industrial corridors and undeveloped land
- Avoid eminent domain takings of homes and churches
- Preserve community integrity

**2. PRIORITIZE TRANSIT over highway expansion in populated areas**
- Transit connects communities; highways divide them
- Focus on elevated or underground solutions where necessary
- Use existing rights-of-way (rail corridors, utility easements)

**3. INVEST FIRST in underserved communities**
- Southside Atlanta (predominantly Black, lower-income) gets priority
- Murphy Crossing BeltLine connection serves Southwest Atlanta first
- Extend transit to Clayton County (51% Black, median income $56K)

**4. ANTI-DISPLACEMENT protections**
- Community land trusts to preserve affordable housing near new stations
- Right of return guarantees for any displaced residents
- Local hiring requirements (60% from affected communities)
- Small business protection and relocation assistance

**5. COMMUNITY GOVERNANCE**
- Community boards with veto power over designs affecting their neighborhoods
- Majority representation from impacted residents
- Transparent decision-making with public comment periods
...
1. **Murphy Crossing Station + BeltLine Southside Trail Light Rail**
   - Connects Southwest Atlanta (English Avenue, Vine City, Bankhead) to transit
   - Creates jobs and economic opportunity without displacement
   - Protected affordable housing development (40% affordable units required)
   - **Investment**: $1.5-2B
   - **Communities served**: 150,000 residents, 65% Black, median income $35K

2. **Clayton County Extension (Airport → Union City → Fairburn)**
   - Finally brings MARTA to Clayton County (historically excluded)
   - Serves working-class communities with long commutes
   - **Investment**: $1.2-1.5B
   - **Communities served**: 200,000 residents, 51% Black

3. **Joseph E. Boone Infill Station**
   - Serves historically Black neighborhoods (Mozley Park, English Avenue)
   - Fills 3-mile gap in current system
   - **Investment**: $150-200M

4. **Smart Traffic Management (Citywide)**
   - Benefits ALL communities immediately
   - No displacement risk
   - **Investment**: $500M

**Phase 1 Total**: $3.35-4.2B focused on equity

### Phase 2 (Years 6-10): EAST/WEST EXPANSION

**Priority Projects:**

1. **Complete BeltLine Rail Loop**
   - With mandatory affordable housing preservation
   - Community land trusts at each station
   - **Investment**: $2-2.5B

2. **East Side Extensions (DeKalb County)**
   - Indian Creek → Stonecrest → Lithonia
   - Serves South DeKalb's Black middle-class communities
   - Economic development without gentrification
   - **Investment**: $1.5-2B

3. **West Side Extensions (Cobb County)**
   - Hamilton E. Holmes → Marietta
   - Serves working-class communities historically excluded from MARTA
   - **Investment**: $1.8-2.2B

4. **I-285 Express Lanes (Northern Arc Only)**
   - Keeps trucks and through-traffic on outer ring
   - Does NOT expand highways through residential areas
   - **Investment**: $3-4B

**Phase 2 Total**: $8.3-10.7B

### Phase 3 (Years 11-20): REGIONAL COMPLETION

**Note**: Outer perimeter loop ONLY if:
- Routes through industrial/undeveloped land confirmed
- Zero residential displacement
- Community approval obtained
- Alternative: Enhanced freight rail to reduce truck traffic

---

## Community-Specific Benefits

### Southwest Atlanta (English Avenue, Vine City, Bankhead, West End)
**Current Issues:**
- Limited transit access, high unemployment
- Food deserts, limited economic opportunity
- Legacy of displacement from I-20 construction

**Improvements:**
- Murphy Crossing MARTA station + BeltLine connection
- Joseph E. Boone infill station
- Direct connection to job centers (Downtown, Midtown, Buckhead)
- Protected affordable housing (community land trust model)
- Local business incubators at transit stations

**Investment**: $2B | **Residents Served**: 150,000+ | **Jobs Created**: 5,000-7,000

### South DeKalb (Lithonia, Stonecrest, Conley)
**Current Issues:**
- 45-60 minute commutes to job centers
- Car-dependent with high transportation costs
- Limited access to MARTA rail

**Improvements:**
- Blue Line extension (Indian Creek → Stonecrest → Lithonia)
- Bus rapid transit connections
- Park-and-ride facilities

**Investment**: $1.5-2B | **Residents Served**: 200,000+ | **Time Savings**: 30-40 min/day

### Clayton County (College Park, East Point, Union City, Fairburn)
**Current Issues:**
- Historically excluded from MARTA (racist referendums in 1960s-70s)
- Heavy reliance on cars, congested roads
- Limited connections to Atlanta job market

**Improvements:**
- Red/Gold Line extensions south of airport
- Finally joins MARTA system after 50+ years
- Economic development opportunities

**Investment**: $1.2-1.5B | **Residents Served**: 200,000+ | **New Transit Access**: 0% → 40%

### Old Fourth Ward, Sweet Auburn, Summerhill
**Current Issues:**
- Gentrification pressure from BeltLine
- Historic Black communities at risk of displacement
- Already impacted by past highway construction

**Improvements:**
- Krog Street infill station
- BeltLine rail with 40% affordable housing requirement
- Community land trusts to prevent displacement
- Historic preservation funding
- Right-of-return for displaced families

**Investment**: $800M-1B | **Residents Protected**: 50,000+ | **Affordable Units**: 5,000+

---

## What We're NOT Doing (Anti-Displacement Commitments)

❌ **NO highway expansion through residential neighborhoods**
- No widening of I-75/85 Downtown Connector through Black communities
- No new interchanges that would require demolition
- Outer loop ONLY if zero residential impact

❌ **NO transit-induced displacement without protection**
- Every new station includes community land trust
- 40% affordable housing requirement within 1/2 mile
- Right of return for any displaced residents
- Rent stabilization programs

❌ **NO "urban renewal" schemes disguised as transit**
- Community veto power over development plans
- Majority-Black community boards for oversight
- Transparent procurement with local business preference

❌ **NO suburban bias in funding allocation**
- Southside and Clayton County get 60% of Phase 1 funding
- Suburban extensions only after equity priorities met
- No express lanes that benefit wealthy commuters first

---

## Revised Investment Priorities

### Equity-First Budget (20 years)

| Priority Tier | Projects | Investment | Communities |
|---------------|----------|------------|-------------|
| **Tier 1: Equity** | Southside transit, Clayton County, infill stations | $15-18B | Black, low-income, transit-dependent |
| **Tier 2: Regional** | BeltLine, East/West extensions | $12-15B | Mixed-income, diverse |
| **Tier 3: Suburban** | North Fulton, Gwinnett, Cobb extensions | $8-10B | Affluent, car-dependent |
| **Tier 4: Highways** | Smart systems, limited express lanes | $5-8B | Regional traffic |

**Total**: $40-51B (NO outer perimeter unless community-approved)

**Funding Allocation:**
- 60% to majority-Black/low-income communities
- 25% to mixed-income regional projects
- 15% to affluent suburban areas (who can also self-fund)
